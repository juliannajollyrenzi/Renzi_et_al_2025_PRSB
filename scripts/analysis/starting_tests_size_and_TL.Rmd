...
```{r}
weights <- read_csv(here("july2024_updates/data/initial_buoyant_weights.csv"))
...
```{r}
surv_df <- read_csv(here("july2024_updates/generated_data/coral_survival37.csv")) %>% # from the survival_wrangling.Rmd script
...
tissueLoss <- read_csv(here("july2024_updates/data/coral_tissue_loss.csv"))
