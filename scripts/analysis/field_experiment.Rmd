...
algae <- read_csv(here("july2024_updates/data/field_experiment/algae_weight.csv"))

# information on colony size (for summary stat in text)
size <- read_csv(here("july2024_updates/data/field_experiment/colony_specs.csv")) 

# daily monitoring of whether algae was present or not
monitoring <- read_csv(here("july2024_updates/data/field_experiment/algal_monitoring.csv")) 
```
...
# pdf(here("july2024_updates/figures/field_algal_loss.pdf"), height = 4, width = 6)
...
```{r plot}
# pdf(here("july2024_updates/figures/field_monitoring.pdf"), height = 5.5, width = 7)
