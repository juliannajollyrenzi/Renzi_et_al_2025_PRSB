...
perCover <- read_csv(here("july2024_updates/data/crab_feeding_imageJ.csv"))

# bring in the bite count data from the videos
behavior <- read_csv(here("july2024_updates/data/crab_feeding_behavior.csv"))
```
...
# pdf(here("july2024_updates/figures/feeding_pref.pdf"), width = 6, height = 4)
strauss_long %>% 
  # plot
